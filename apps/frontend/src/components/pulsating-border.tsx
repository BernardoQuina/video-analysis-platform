...
export function PulsatingBorder({
  ...
  return (
    <div
      className={cn(
        'relative flex w-fit items-center overflow-hidden rounded-full p-[1px]',
        className,
      )}
    >
      ...
      <div className="bg-background z-20 w-full flex-row items-center gap-1.5 rounded-full p-2">
        {children}
      </div>
    </div>
  );
