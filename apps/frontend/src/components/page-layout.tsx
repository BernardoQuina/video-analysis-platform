...
export function PageLayout({
  ...
  return (
    <div className="items-center overflow-x-clip">
      ...
      {backgroundEffects && (
        <>
          <div className="bg-background/95 supports-[backdrop-filter]:bg-background/50 dark:supports-[backdrop-filter]:bg-background/70 fixed -z-10 h-full w-full backdrop-blur-2xl"></div>
