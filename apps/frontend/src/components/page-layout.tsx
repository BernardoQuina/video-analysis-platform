    ...
    <div className="items-center overflow-x-clip">
      ...
      {backgroundEffects && (
        <>
          ...
          <div className="blob animate-blob1 fixed left-1/3 top-[40%] -z-20 h-[50vw] max-h-[600px] w-[50vw] max-w-[600px] -translate-x-1/2 -translate-y-1/2 bg-gradient-to-r from-red-400 via-purple-500 to-blue-500 opacity-50 sm:top-1/2 dark:from-red-600 dark:via-purple-700 dark:to-blue-700"></div>
