...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="sticky top-[6.2rem] z-[9] flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        'flex flex-1 flex-row items-center justify-between py-4 text-left text-sm font-medium transition-all [&[data-state=open]>svg]:rotate-180',
        className,
      )}
      {...props}
    >
