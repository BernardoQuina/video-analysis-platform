...
export function VideoLayout({ thumbnails }: VideoLayoutProps) {
  return (
    <>
      ...
      /> */}
      <Controls.Root className="media-controls:opacity-100 absolute bottom-0 z-10 -mt-[82px] flex h-fit w-full flex-col bg-gradient-to-t from-black/60 to-transparent opacity-0 transition-opacity">
        <Tooltip.Provider>
